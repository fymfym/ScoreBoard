...
extern const unsigned char SETTINGGREEN;
extern const unsigned char SETTINGRED;
extern const unsigned char SETTINGYELLOW;
extern const unsigned char SETTINGWHITE;
